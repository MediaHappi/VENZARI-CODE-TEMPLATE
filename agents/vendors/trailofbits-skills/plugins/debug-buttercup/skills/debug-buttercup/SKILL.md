...
description: >
  ...
  task-server, task-downloader, program-model, venzarai-router, dind, tracer-bot,
...
| Layer | Services |
|-------|----------|
| Infra | redis, dind, venzarai-router, registry-cache |
...
- **Patcher**: VenzariAI Router connectivity, LLM timeout, patch queue depth
